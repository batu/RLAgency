...
PROTOTYPE_NAME = "JumpConfig"
EXPERIMENT_NAME = f"Testing"
    ...
    for ratio_adjust in hyperparameter_list_2:
      for SDE in hyperparameter_list_1:
        for envcount, envname in environments:
          ...
          wandb_config, network_config, alg_config, channels = setup_configurations("rlnav/configs/SAC_rlnav_defaults.yaml")
